      ...
      <table id="example1" class="table table-bordered table-striped">
        ...
        <tr>
          ...
          <td>
            ...
            <a href="<?php echo base_url('User/edit_data_kelas'); ?>" class="btn btn-primary"><i class="fa fa-edit"></i> Edit</a>
            <a href="<?php echo base_url('User/hapus_data_kelas'); ?>" class="btn btn-danger"><i class="fa fa-trash"></i> Hapus</a></td>
        </tr>
      <?php $no++;} ?>
        </tbody>
      </table>
